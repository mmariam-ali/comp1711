...
int main() {
    ...
    Student students[N_STUDENTS] = { //struct named students defined with 4 students
    ...
    int extractedData[N_STUDENTS][N_MODULES]; //2d array is created and passed to extract and store function
